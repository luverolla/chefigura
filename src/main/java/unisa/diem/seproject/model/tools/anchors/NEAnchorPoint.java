...
public class NEAnchorPoint implements AnchorPoint {
    ...
    public void mouseMove(double mouseX, double mouseY) {
        if (sm.selectedShapeProperty.get() != null) {
            if (sm.selectedShapeProperty.get().getBounds().mouseOnNEAnchorPoint(mouseX, mouseY, sm.getZoomFactor())) {
    ...
    public void mouseDragStart(double mouseX, double mouseY) {
        if (sm.selectedShapeProperty.get() != null && sm.selectedShapeProperty.get().getBounds().mouseOnNEAnchorPoint(mouseX, mouseY, sm.getZoomFactor())) {
            isDragging = true;
